...
public class TestDBConnection {
    ...
    //private static final String TEST_XML_PATH = "src/META-INF/hibernateTest.cfg.xml";
    ...
    private static SessionFactory buildSessionFactory() {
        try {
        	...
        	return new Configuration()
					...
					.setProperty("hibernate.connection.url","jdbc:mysql://localhost/mydbteste?useTimezone=true&serverTimezone=UTC")
