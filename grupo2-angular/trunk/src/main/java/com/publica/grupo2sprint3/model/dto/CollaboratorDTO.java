...
//		this.setCanVacation(collab.getCanVacation());
	...
	public String getVacationSalary() {
		return vacationSalary;
	}

	public void setVacationSalary(String vacationSalary) {
