...
public class PayrollAPI {
	...
	public Response insert(Payroll payroll) {
		...
		try {
			...
			//ArrayList<Payroll> payrolls = payrollController.findByCollab((collab.getId()));
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response findByCollab(@PathParam("id") String id) {
		try {
	...
	public Response find(@PathParam("id") String id) {
		try {
			...
			if (payroll == null) {
				...
				builder = Response.status(Response.Status.OK).entity(payroll);
			}
