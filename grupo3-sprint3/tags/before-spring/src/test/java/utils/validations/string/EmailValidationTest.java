...
public class EmailValidationTest {
	...
	private final String NOTINVALID_EMAIL2 = "c@abc.com";
	private final String INVALID_EMAIL3 = "abc@abc.abcabcabc";
	private final String NOTINVALID_EMAIL4 = "issoeumemail@muitomuitomuitogrande.com";
	...
	public void isEmailValidTest() {
		...
		Assert.assertTrue(EmailValidation.isEmailValid(NOTINVALID_EMAIL2));
		...
		Assert.assertTrue(EmailValidation.isEmailValid(NOTINVALID_EMAIL4));
	}
}
