...
import controller.services.ServicoCEP;
import utils.UtilsNumber;
import utils.validations.number.CEPValidation;

/***
 * Um objeto com informações de endereço.
 * 
 ...
 * para extrair as demais informações, exceto complemento. Também
 * é possível definir essas informações com os setters do objeto.
...
public class Endereco {
	...
	/***
	 * Construtor que recebe somente o cep, e recebe as informações 
	 * de ServicoCEP.java. 
	 * 
	 * @param cep
	 */
	...
	/***
	 * Construtor que recebe o cep e um complemento, completando as informações
	...
	/***
	 * Override do método toString para informar todos os campos deste
	 * objeto.
	 */
	@Override
