 ...
 * cnpj and selecting all Payrolls.
 * 
 * @version 1.6.0
 * 
...
public class PayrollHibernate extends HibernateDataAccess {
	 ...
	 * @author Giovanni Buzzi
	 * @param value  TODO
	 * @param collab the Collaborator object referenced in the payroll registry to
	 *               be found
	 * 
	 * @return the Payroll object found
	 */
	public ArrayList<Payroll> findByCollab(String field, String value) {
		try {
			Session session = sessionFactory.openSession();
			session.beginTransaction();
			Collaborator collab = (Collaborator) new CollaboratorHibernate().find(field, value);
